...
- **🗣 Voices** = what the people who move markets actually SAID today, from the dedicated
  feeds: source "Truth Social (Trump)" carries Trump's raw posts; "Google News · Trump says",
  "· Fed speak" and "· Musk / X posts" catch the wire echo of X/podium remarks. Quote the
  key line (short, in quotes) then give the desk read: did the market move on it, was it
  signal or noise, and for which market. 1–3 bullets max; if the tape was quiet today, OMIT
  the section — never pad it with routine commentary ABOUT these people, only their own
  words/posts.
